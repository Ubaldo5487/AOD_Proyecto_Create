...
<head>
    ...
    <!-- CSS de DataTable -->
    <link rel="stulesheet" href="{{ asset('dist/css/jquery.dataTables.min.css') }}">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('cellphones') }}" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('pets') }}" class="nav-link active">
                                        <i class="fas fa-paw nav-icon"></i>
                                        <p>Mascotas</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('songs') }}" class="nav-link active">
